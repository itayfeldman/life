...
class TilePattern:
    ...
    @staticmethod
    def four_corners(NW: State) -> State:
        """
        Radial symmetry, e.g.:
        ```
        A B B A
