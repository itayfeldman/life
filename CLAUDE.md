...
- After ANY correction from the user: update 'tasks/lessons.md' with the new pattern
- Write rules for yourself that prevent the same mistake
- Ruthlessly iterate on these lessons unitl mistate rate drops
...
- For non-trivial changes: pause and aks "is there a more elegant way?"
- If a fix feels hackey: "Knowing everything I know now, implement the elegant solution"
